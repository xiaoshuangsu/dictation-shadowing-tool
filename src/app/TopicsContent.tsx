        ...
        <div className="py-8">
          {isLoading && Object.keys(materialsByCategory).length === 0 ? (
            ...
            <div className="text-center py-16">
              <svg className="mx-auto h-16 w-16 text-yellow-300 mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
              </svg>
              <h3 className="text-lg font-medium text-gray-700 mb-2">数据加载极慢，请稍后刷新</h3>
              <p className="text-gray-500 mb-6">Database connection is slow. Please try again later.</p>
              <button
